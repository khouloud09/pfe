                    ...
                    <div className="form-group ">
                        <div className='toggle-input active' >
                            ...
                            <input type="radio" id="typ1" name="check" value="A vendre"
                                onChange={(e) => setNewAnnonce({ ...newAnnonce, typeAnnonce: e.target.value })} checked={annonce?.typeAnnonce === "A vendre"} />
                             <label for="typ1">  A Vendre  </label>
                        </div >
                        <div className='toggle-input btn-default'>
                            <input type="radio" id="typ2" name="check" value="A Louer"
                                onChange={(e) => setNewAnnonce({ ...newAnnonce, typeAnnonce: e.target.value })} checked={annonce?.typeAnnonce === "A Louer"} />
